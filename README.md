# [Physicist][arxiv], [Programmer][projects], [Photographer][photos]
...
mass of [neutrinos][nu], furthering our understanding of the universe [beyond the
standard model][BSM] of particle physics.

In our lab, we characterize [Silicon PhotoMultipliers][oqual] through detection
of [single photon events][spe]. By understanding the detector very precisely we
can use it to study the reflectivity of materials in liquid xenon, aiding in the
development of nEXO.
...
production at the [Large Hadron Collider][lhc], and developed a project to
automate [truth-level reinterpretations][recast] of particle physics analyses.
